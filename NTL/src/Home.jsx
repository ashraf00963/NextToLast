...
function HomePage () {
    ...
    const instance = axios.create({
        baseURL: 'https://54.93.168.94:3002',
    });
    ...
    useEffect(() => {
        ...
        const fetchWatches = async () => {
            try {
                const response = await axios.get('https://54.93.168.94:3002/watches');
    ...
    const addToBasket = async (watchId) => {
        try {
            ...
            const response = await axios.post('https://54.93.168.94:3002/basket/add', { id: watchId });
